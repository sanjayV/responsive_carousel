...
InfiniteCarousel.prototype = {
    setCarouselWidth: function() {
        var _this = this;
        _this.contentWidth = parseInt($(_this.baseClass).find('ul li').outerWidth(true));
        _this.totalContent = $(_this.baseClass).find('ul li').length;
    ...
    slideCarousel: function(direction) {
        ...
        if (_this.contentWidth != '') {
            ...
            $(_this.baseClass).find('ul').animate({
                'margin-left': movePos
            }, 500);
        }
    },
    ...
    resizeEvent: function() {
        ...
        $( window ).resize(function() {
            ...
            $(_this.baseClass).find('ul').css('margin-left', 0);
            _this.slidePosTemp = 0;
        });
    }
};
...
$(function() {
    var firstSlider = new InfiniteCarousel({baseClass: '.infinite-carousel'});
